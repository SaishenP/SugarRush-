  ...
  <body>
    ...
    <section id="prodetails" class="section-p1">
        ...
        <div class="single-pro-details">
            <?php
                ...
                // Query to retrieve the productID from the database
                $sql = "SELECT ProductID FROM sugar_rush WHERE ..."; // Modify this query based on your table structure and conditions

                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    // Retrieve the productID from the result set
                    $row = $result->fetch_assoc();
                    $productID = $row["ProductID"];
                } else {
                    // No matching productID found
                    $productID = null;
                }
    ...
    <script>
      ...
      smallimg[3].onclick = function(){
        ...
        window.location.href = "cart12.php?product_id=" + productID + "&quantity=" + quantity;
    }
